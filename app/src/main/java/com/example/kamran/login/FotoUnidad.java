...
public class FotoUnidad extends AppCompatActivity {
    ...
    String encodedImage, firmadefault, encodedImage2, camarafrontal, rotarimagen, rotarimagencapturada;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            rotarimagencapturada = prefs.getString("rotarimagenfotocapturada", "0");
    ...
    PictureCallback pictureCallback = new PictureCallback()  {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (camarafrontal.equals("SI")) {
                ...
                bitmap = rotateImage(bitmap, Integer.parseInt(rotarimagencapturada));
            }
            else
            {
