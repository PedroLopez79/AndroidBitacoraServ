    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtfechahora.setText(String.format("%02d",c.get(Calendar.DAY_OF_MONTH)) + "/" + String.format("%02d",c.get(Calendar.MONTH)+1) + "/" + String.format("%04d",c.get(Calendar.YEAR)) + " " + String.format("%02d",c.get(Calendar.HOUR_OF_DAY)) + ":" + String.format("%02d",c.get(Calendar.MINUTE)) + ":" + "00");
            }
        });
